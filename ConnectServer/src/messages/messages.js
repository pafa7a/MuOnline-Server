...
export function encodeServerInfo(message) {
  let bb = popByteBuffer();
  _encodeServerInfo(message, bb);
  return toUint8Array(bb);
}

function _encodeServerInfo(message, bb) {
...
export function decodeServerInfo(binary) {
  return _decodeServerInfo(wrapByteBuffer(binary));
}

function _decodeServerInfo(bb) {
  let message = {};
...
export function encodeServerListResponse(message) {
  let bb = popByteBuffer();
  _encodeServerListResponse(message, bb);
  return toUint8Array(bb);
}

function _encodeServerListResponse(message, bb) {
  ...
  if (array$servers !== undefined) {
    for (let value of array$servers) {
      ...
      _encodeServerInfo(value, nested);
...
export function decodeServerListResponse(binary) {
  return _decodeServerListResponse(wrapByteBuffer(binary));
}

function _decodeServerListResponse(bb) {
  let message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        values.push(_decodeServerInfo(bb));
        bb.limit = limit;
        break;
      }
