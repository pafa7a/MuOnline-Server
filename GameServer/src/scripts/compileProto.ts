...
const compileTsCommand = `protoc --plugin=protoc-gen-ts_proto=".\\node_modules\\.bin\\protoc-gen-ts_proto.cmd" --ts_proto_out=. src/messages/gameserver.proto`;
...
const compileCSharpCommand = `protoc --csharp_out=src/messages/ src/messages/gameserver.proto`;
